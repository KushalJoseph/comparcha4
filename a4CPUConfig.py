...
def createCPU(options, processes, system):
    ...
    # elif options.cse530_core_config=="ultrahard":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 168
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="superhard":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 144
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="hard":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 120
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="medium":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 96
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="soft":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 72
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="supersoft":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 48
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    # elif options.cse530_core_config=="ultrasoft":
    #     options.cse530_issue_width = 8
    #     options.branch_predictor = "ltage"
    #     options.cse530_num_robs= 24
    #     a4O3CPUConfig.initializeO3CPU(options, cpu)
    ...
    # Vary BRANCH PREDICTOR
    if options.cse530_core_config=="small":
        options.cse530_issue_width = 2
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 16
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    if options.cse530_core_config=="hard":
        options.cse530_issue_width = 8
        options.branch_predictor = "tournament"
        options.cse530_num_robs= 192
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    if options.cse530_core_config=="medium":
        options.cse530_issue_width = 8
