...
--outdir=predictor/m5out_Bubblesort_large \
--redirect-stdout \
--redirect-stderr \
...
/home/other/CSE530-FA2022/gem5/build_a4/build/X86/gem5.opt \
--outdir=predictor/m5out_Bubblesort_hard \
--redirect-stdout \
--redirect-stderr \
cse530_a4_sys_config.py \
...
/home/other/CSE530-FA2022/gem5/build_a4/build/X86/gem5.opt \
--outdir=predictor/m5out_Bubblesort_medium \
--redirect-stdout \
--redirect-stderr \
cse530_a4_sys_config.py \
--cse530-core-config=medium \
--binfile=benchmarks/stanford/Bubblesort \
--l1i_size "4kB" \
--l1d_size "4kB" \
--l2_size "32kB"
...
/home/other/CSE530-FA2022/gem5/build_a4/build/X86/gem5.opt \
--outdir=predictor/m5out_Bubblesort_soft \
--redirect-stdout \
--redirect-stderr \
cse530_a4_sys_config.py \
